...
create_dir()
{
    ...
    if [[ ! -e "$path" ]]; then
      execute "INFO: creating path: '$path'" "ERROR: unable to create directory '$path'" \
          mkdir "-pv" "$path"
    else
      echo "DEBUG: directory already exists, skipping creation." 1>> $LOG_FILE 2>&1
    fi
    execute "INFO: updating path permissions: '$path'" "ERROR: unable to update permissions on '$path'" \
...
remove_path()
{
    local options=$1
    local path="$2"
    local skip_if_missing=${3:-false}  # Default to false

    echo "DEBUG: removing path ${path}" 1>> $LOG_FILE 2>&1

    if [ -z "$path" ]; then
        error_exit "ERROR: path argument is required"
    fi

    if [ "$skip_if_missing" = "true" ] && [ ! -e "$path" ]; then
    ...
    if [[ -e "$path" ]]; then
      ...
      execute "INFO: removing path: '$path'" "ERROR: unable to remove path '$path'" \
          rm $options "$path"
    fi
}
...
change_dir()
{
    ...
    if [[ -e "$path" ]]; then
      execute "INFO: changing to path: '$path'" "ERROR: unable to cd to directory '$path'" \
          cd "$path"
    else
      echo "INFO: path ${path} does not exist" 1>> $LOG_FILE 2>&1
    fi
...
get_library_name() {
  ...
  101) echo "curl" ;;
  102) echo "davs2" ;;
  103) echo "decklink-headers" ;;
  104) echo "dlfcn-win32" ;;
  105) echo "dovi-tool" ;;
  106) echo "dovi-tool-bin" ;;
  107) echo "fdk-aac" ;;
  108) echo "ffmpeg" ;;
  109) echo "fftw" ;;
  110) echo "flac" ;;
  ...
  117) echo "gpac" ;;
  118) echo "l-smash" ;;
  119) echo "l-smash-works" ;;
  120) echo "lcms" ;;
  121) echo "lensfun" ;;
  122) echo "libaribcaption" ;;
  123) echo "libarchive" ;;
  124) echo "libbluray" ;;
  125) echo "libbs2b" ;;
  126) echo "libcaca" ;;
  ...
  133) echo "libgme" ;;
  134) echo "libidn2" ;;
  135) echo "libjpeg-turbo" ;;
  136) echo "libmodplug" ;;
  137) echo "libmysofa" ;;
  138) echo "libmxf" ;;
  139) echo "libopencore" ;;
  140) echo "libopenh264" ;;
  141) echo "libopenjpeg" ;;
  142) echo "libopus" ;;
  143) echo "libplacebo" ;;
  144) echo "libproxy" ;;
  145) echo "libpsl" ;;
  ...
  155) echo "lua" ;;
  156) echo "lz4" ;;
  157) echo "mfx-dispatch" ;;
  158) echo "mingw-std-threads" ;;
  159) echo "mplayer" ;;
  160) echo "mplayer-ffmpeg" ;;
  161) echo "mpg123" ;;
  162) echo "nghttp2" ;;
  163) echo "nv-codec-headers" ;;
  164) echo "openmpt" ;;
  165) echo "openssl-1-0-2" ;;
  166) echo "openssl-1-1-1" ;;
  167) echo "opencv" ;;
  168) echo "qt" ;;
  169) echo "sdl2" ;;
  170) echo "shaderc" ;;
  171) echo "speexdsp" ;;
  172) echo "spirv-cross" ;;
  173) echo "svt-av1" ;;
  174) echo "svt-hevc" ;;
  175) echo "svt-vp9" ;;
  176) echo "tensorflow" ;;
  177) echo "transform360" ;;
  178) echo "vamp-plugin-sdk" ;;
  179) echo "vlc" ;;
  180) echo "vmaf" ;;
  181) echo "vulkan-headers" ;;
  182) echo "vulkan-shim-loader" ;;
  183) echo "xavs" ;;
  184) echo "xavs2" ;;
  185) echo "xxhash" ;;
  186) echo "xz" ;;
...
from_library_name() {
  ...
  ios-bzip2 | macos-bzip2 | tvos-bzip2 | windows-bzip2) echo 54 ;;
  ...
  curl) echo 101 ;;
  davs2) echo 102 ;;
  decklink-headers) echo 103 ;;
  dlfcn-win32) echo 104 ;;
  dovi-tool) echo 105 ;;
  dovi-tool-bin) echo 106 ;;
  fdk-aac) echo 107 ;;
  ffmpeg) echo 108 ;;
  fftw) echo 109 ;;
  flac) echo 110 ;;
  ...
  gpac) echo 117 ;;
  l-smash) echo 118 ;;
  l-smash-works) echo 119 ;;
  lcms) echo 120 ;;
  lensfun) echo 121 ;;
  libaribcaption) echo 122 ;;
  libarchive) echo 123 ;;
  libbluray) echo 124 ;;
  libbs2b) echo 125 ;;
  libcaca) echo 126 ;;
  ...
  libgme) echo 133 ;;
  libidn2) echo 134 ;;
  libjpeg-turbo) echo 135 ;;
  libmodplug) echo 136 ;;
  libmysofa) echo 137 ;;
  libmxf) echo 138 ;;
  libopencore) echo 139 ;;
  libopenh264) echo 140 ;;
  libopenjpeg) echo 141 ;;
  libopus) echo 142 ;;
  libplacebo) echo 143 ;;
  libproxy) echo 144 ;;
  libpsl) echo 145 ;;
  ...
  lua) echo 155 ;;
  lz4) echo 156 ;;
  mfx-dispatch) echo 157 ;;
  mingw-std-threads) echo 158 ;;
  mplayer) echo 159 ;;
  mplayer-ffmpeg) echo 160 ;;
  mpg123) echo 161 ;;
  nghttp2) echo 162 ;;
  nv-codec-headers) echo 163 ;;
  openmpt) echo 164 ;;
  openssl-1-0-2) echo 165 ;;
  openssl-1-1-1) echo 166 ;;
  opencv) echo 167 ;;
  qt) echo 168 ;;
  sdl2) echo 169 ;;
  shaderc) echo 170 ;;
  speexdsp) echo 171 ;;
  spirv-cross) echo 172 ;;
  svt-av1) echo 173 ;;
  svt-hevc) echo 174 ;;
  svt-vp9) echo 175 ;;
  tensorflow) echo 176 ;;
  transform360) echo 177 ;;
  vamp-plugin-sdk) echo 178 ;;
  vlc) echo 179 ;;
  vmaf) echo 180 ;;
  vulkan-headers) echo 181 ;;
  vulkan-shim-loader) echo 182 ;;
  xavs) echo 183 ;;
  xavs2) echo 184 ;;
  xxhash) echo 185 ;;
  xz) echo 186 ;;
...
is_library_supported_on_platform() {
  ...
  # IOS, MACOS, TVOS AND WINDOWS
  54)
    if [[ ${FFMPEG_KIT_BUILD_TYPE} == "ios" ]] || [[ ${FFMPEG_KIT_BUILD_TYPE} == "tvos" ]] || [[ ${FFMPEG_KIT_BUILD_TYPE} == "macos" ]] || [[ ${FFMPEG_KIT_BUILD_TYPE} == "windows" ]]; then
      echo "0"
    else
      echo "1"
    fi
  ...
  93 | 94 | 95 | 96 | 97 | 98 | 99 | 100 | 101 | 102 | 103 | 104 | 105 | 106 | 107 | 108 | 109 | 110 | 111 | 112 | 113 | 114 | 115 | 116 | 117 | 118 | 119 | 120 | 121 | 122 | 123 | 124 | 125 | 126 | 127 | 128 | 129 | 130 | 131 | 132 | 133 | 134 | 135 | 136 | 137 | 138 | 139 | 140 | 141 | 142 | 143 | 144 | 145 | 146 | 147 | 148 | 149 | 150 | 151 | 152 | 153 | 154 | 155 | 156 | 157 | 158 | 159 | 160 | 161 | 162 | 163 | 164 | 165 | 166 | 167 | 168 | 169 | 170 | 171 | 172 | 173 | 174 | 175 | 176 | 177 | 178 | 179 | 180 | 181 | 182 | 183 | 184 | 185 | 186 | 187 | 188 | 189)
    if [[ ${FFMPEG_KIT_BUILD_TYPE} == "windows" ]]; then
      case $1 in
        bzip2 | dlfcn-win32 | libvpl | mfx-dispatch | mingw-std-threads)
          echo "0"
          ;;
        *)
          echo "1"
...
set_library() {
  ...
  aribb24)
    ...
    ;;
  audiotoolboxwrapper)
    ENABLED_LIBRARIES[LIBRARY_AUDIOTOOLBOXWRAPPER]=$2
    ;;
  avisynth)
    ENABLED_LIBRARIES[LIBRARY_AVISYNTH]=$2
    ;;
  brotli)
    ENABLED_LIBRARIES[LIBRARY_BROTLI]=$2
    ;;
  bzip2)
    ENABLED_LIBRARIES[LIBRARY_BZIP2]=$2
    ;;
  config)
    ENABLED_LIBRARIES[LIBRARY_CONFIG]=$2
    ;;
  cpuinfo)
    ENABLED_LIBRARIES[LIBRARY_CPUINFO]=$2
    ;;
  curl)
    ENABLED_LIBRARIES[LIBRARY_CURL]=$2
    ;;
  davs2)
    ENABLED_LIBRARIES[LIBRARY_DAVS2]=$2
    ;;
  decklink-headers)
    ENABLED_LIBRARIES[LIBRARY_DECKLINK_HEADERS]=$2
    ;;
  dlfcn-win32)
    ENABLED_LIBRARIES[LIBRARY_DLFCN_WIN32]=$2
    ;;
  dovi-tool)
    ENABLED_LIBRARIES[LIBRARY_DOVI_TOOL]=$2
    ;;
  dovi-tool-bin)
    ENABLED_LIBRARIES[LIBRARY_DOVI_TOOL_BIN]=$2
    ;;
  fdk-aac)
    ENABLED_LIBRARIES[LIBRARY_FDK_AAC]=$2
    ;;
  ffmpeg)
    ENABLED_LIBRARIES[LIBRARY_FFMPEG]=$2
    ;;
  fftw)
    ENABLED_LIBRARIES[LIBRARY_FFTW]=$2
    ;;
  flac)
    ENABLED_LIBRARIES[LIBRARY_FLAC]=$2
    ;;
  flite)
    ENABLED_LIBRARIES[LIBRARY_FLITE]=$2
    ;;
  frei0r)
    ENABLED_LIBRARIES[LIBRARY_FREI0R]=$2
    ;;
  gettext)
    ENABLED_LIBRARIES[LIBRARY_GETTEXT]=$2
    ;;
  glfw)
    ENABLED_LIBRARIES[LIBRARY_GLFW]=$2
    ;;
  glew)
    ENABLED_LIBRARIES[LIBRARY_GLEW]=$2
    ;;
  glib)
    ENABLED_LIBRARIES[LIBRARY_GLIB]=$2
    ;;
  gpac)
    ENABLED_LIBRARIES[LIBRARY_GPAC]=$2
    ;;
  l-smash)
    ENABLED_LIBRARIES[LIBRARY_L_SMASH]=$2
    ;;
  l-smash-works)
    ENABLED_LIBRARIES[LIBRARY_L_SMASH_WORKS]=$2
    ;;
  lcms)
    ENABLED_LIBRARIES[LIBRARY_LCMS]=$2
    ;;
  lensfun)
    ENABLED_LIBRARIES[LIBRARY_LENSFUN]=$2
    ;;
  libaribcaption)
    ENABLED_LIBRARIES[LIBRARY_LIBARIBCAPTION]=$2
    ;;
  libarchive)
    ENABLED_LIBRARIES[LIBRARY_LIBARCHIVE]=$2
    ;;
  libbluray)
    ENABLED_LIBRARIES[LIBRARY_LIBBLURAY]=$2
    ;;
  libbs2b)
    ENABLED_LIBRARIES[LIBRARY_LIBBS2B]=$2
    ;;
  libcaca)
    ENABLED_LIBRARIES[LIBRARY_LIBCACA]=$2
    ;;
  libdvbpsi)
    ENABLED_LIBRARIES[LIBRARY_LIBDVBPSI]=$2
    ;;
  libdvbt)
    ENABLED_LIBRARIES[LIBRARY_LIBDVBTEE]=$2
    ;;
  libdvdcss)
    ENABLED_LIBRARIES[LIBRARY_LIBDVDCSS]=$2
    ;;
  libdvdnav)
    ENABLED_LIBRARIES[LIBRARY_LIBDVDNAV]=$2
    ;;
  libdvdread)
    ENABLED_LIBRARIES[LIBRARY_LIBDVDREAD]=$2
    ;;
  libffi)
    ENABLED_LIBRARIES[LIBRARY_LIBFFI]=$2
    ;;
  libgme)
    ENABLED_LIBRARIES[LIBRARY_LIBGME]=$2
    ;;
  libidn2)
    ENABLED_LIBRARIES[LIBRARY_LIBIDN2]=$2
    ;;
  libjpeg-turbo)
    ENABLED_LIBRARIES[LIBRARY_LIBJPEG_TURBO]=$2
    ;;
  libmodplug)
    ENABLED_LIBRARIES[LIBRARY_LIBMODPLUG]=$2
    ;;
  libmysofa)
    ENABLED_LIBRARIES[LIBRARY_LIBMYSOFA]=$2
    ;;
  libmxf)
    ENABLED_LIBRARIES[LIBRARY_LIBMXF]=$2
    ;;
  libopencore)
  ...
  libplacebo)
    ...
    ;;
  libproxy)
    ENABLED_LIBRARIES[LIBRARY_LIBPROXY]=$2
    ;;
  libpsl)
    ENABLED_LIBRARIES[LIBRARY_LIBPSL]=$2
    ;;
  librtmfp)
    ENABLED_LIBRARIES[LIBRARY_LIBRTMFP]=$2
    ;;
  libssh2)
  ...
  libunistring)
    ...
    ;;
  libunwind)
    ENABLED_LIBRARIES[LIBRARY_LIBUNWIND]=$2
    ;;
  libvpl)
    ENABLED_LIBRARIES[LIBRARY_LIBVPL]=$2
    ;;
  libvvdec)
    ENABLED_LIBRARIES[LIBRARY_LIBVVDEC]=$2
    ;;
  libvvenc)
    ENABLED_LIBRARIES[LIBRARY_LIBVVENC]=$2
    ;;
  libxvid)
    ENABLED_LIBRARIES[LIBRARY_LIBXVID]=$2
    ;;
  lua)
    ENABLED_LIBRARIES[LIBRARY_LUA]=$2
    ;;
  lz4)
    ENABLED_LIBRARIES[LIBRARY_LZ4]=$2
    ;;
  mfx-dispatch)
    ENABLED_LIBRARIES[LIBRARY_MFX_DISPATCH]=$2
    ;;
  mingw-std-threads)
    ENABLED_LIBRARIES[LIBRARY_MINGW_STD_THREADS]=$2
    ;;
  mplayer)
    ENABLED_LIBRARIES[LIBRARY_MPLAYER]=$2
    ;;
  mplayer-ffmpeg)
    ENABLED_LIBRARIES[LIBRARY_MPLAYER_FFMPEG]=$2
    ;;
  mpg123)
    ENABLED_LIBRARIES[LIBRARY_MPG123]=$2
    ;;
  nghttp2)
    ENABLED_LIBRARIES[LIBRARY_NGHTTP2]=$2
    ;;
  nv-codec-headers)
    ENABLED_LIBRARIES[LIBRARY_NV_CODEC_HEADERS]=$2
    ;;
  openmpt)
    ENABLED_LIBRARIES[LIBRARY_OPENMPT]=$2
    ;;
  openssl-1-0-2)
    ENABLED_LIBRARIES[LIBRARY_OPENSSL_1_0_2]=$2
    ;;
  openssl-1-1-1)
    ENABLED_LIBRARIES[LIBRARY_OPENSSL_1_1_1]=$2
    ;;
  opencv)
    ENABLED_LIBRARIES[LIBRARY_OPENCV]=$2
    ;;
  qt)
    ENABLED_LIBRARIES[LIBRARY_QT]=$2
    ;;
  sdl2)
    ENABLED_LIBRARIES[LIBRARY_SDL2]=$2
    ;;
  shaderc)
    ENABLED_LIBRARIES[LIBRARY_SHADERC]=$2
    ;;
  speexdsp)
    ENABLED_LIBRARIES[LIBRARY_SPEEXDSP]=$2
    ;;
  spirv-cross)
    ENABLED_LIBRARIES[LIBRARY_SPIRV_CROSS]=$2
    ;;
  svt-av1)
    ENABLED_LIBRARIES[LIBRARY_SVT_AV1]=$2
    ;;
  svt-hevc)
    ENABLED_LIBRARIES[LIBRARY_SVT_HEVC]=$2
    ;;
  svt-vp9)
    ENABLED_LIBRARIES[LIBRARY_SVT_VP9]=$2
    ;;
  tensorflow)
    ENABLED_LIBRARIES[LIBRARY_TENSORFLOW]=$2
    ;;
  transform360)
    ENABLED_LIBRARIES[LIBRARY_TRANSFORM360]=$2
    ;;
  vamp-plugin-sdk)
    ENABLED_LIBRARIES[LIBRARY_VAMP_PLUGIN_SDK]=$2
    ;;
  vlc)
    ENABLED_LIBRARIES[LIBRARY_VLC]=$2
    ;;
  vmaf)
    ENABLED_LIBRARIES[LIBRARY_VMAF]=$2
    ;;
  vulkan-headers)
    ENABLED_LIBRARIES[LIBRARY_VULKAN_HEADERS]=$2
    ;;
  vulkan-shim-loader)
    ENABLED_LIBRARIES[LIBRARY_VULKAN_SHIM_LOADER]=$2
    ;;
  xavs)
    ENABLED_LIBRARIES[LIBRARY_XAVS]=$2
    ;;
  xavs2)
    ENABLED_LIBRARIES[LIBRARY_XAVS2]=$2
    ;;
  xxhash)
    ENABLED_LIBRARIES[LIBRARY_XXHASH]=$2
    ;;
  xz)
    ENABLED_LIBRARIES[LIBRARY_XZ]=$2
    ;;
  zlib)
    ENABLED_LIBRARIES[LIBRARY_ZLIB]=$2
    ;;
  zstd)
    ENABLED_LIBRARIES[LIBRARY_ZSTD]=$2
    ;;
  zvbi)
    ENABLED_LIBRARIES[LIBRARY_ZVBI]=$2
    ;;
  *)
    print_unknown_library $1
    ;;
...
clone_git_repository_with_commit_id() {
  ...
  (create_dir "$2" 1>>"${BASEDIR}"/build.log 2>&1)
  ...
  change_dir "$2" 1>>"${BASEDIR}"/build.log 2>&1
...
clone_git_repository_with_tag() {
  ...
  (create_dir "$3" 1>>"${BASEDIR}"/build.log 2>&1)

  RC=$?

  if [ ${RC} -ne 0 ]; then
    echo -e "\nINFO: Failed to create local directory $3\n" 1>>"${BASEDIR}"/build.log 2>&1
    remove_path -rf "$3" 1>>"${BASEDIR}"/build.log 2>&1
    echo ${RC}
    return
  fi
...
apply_patch() {
  ...
  if [[ ! -e $patch_done_name ]]; then
    if [[ -f $patch_name ]]; then
      remove_path $patch_name || exit 1 # remove old version in case it has been since updated on the server...
    fi
...
download_and_unpack_file() {
  ...
  if [ ! -f "$output_dir/unpacked.successfully" ]; then
    ...
    if [[ -f $output_name ]]; then
      remove_path $output_name || exit 1
    fi
...
build_libtensorflow() { 
  if [[ ! -e Tensorflow ]]; then
    ...
    change_dir Tensorflow
      ...
      remove_path libtensorflow-cpu-windows-x86_64.zip
    change_dir ..
...
build_libdovi() {
  ...
  change_dir dovi_tool_git
	...
	remove_path dovi_tool-2.3.1-x86_64-pc-windows-msvc.zip
      fi
