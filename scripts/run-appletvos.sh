...
-Dc_link_args=\"-arch $host_arch -L${dependency_install_prefix}/lib -lintl -liconv -lresolv -framework CoreFoundation -isysroot ${TVOS_SYSROOT}\" \
-Dcpp_link_args=\"-arch $host_arch -L${dependency_install_prefix}/lib -lintl -liconv -lresolv -framework CoreFoundation -isysroot ${TVOS_SYSROOT}\" \
