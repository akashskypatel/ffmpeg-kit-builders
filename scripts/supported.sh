...
export VALID_PLATFORM_ARCHS=("linux-x86_64" "linux-aarch64" "windows-x86_64" "android-aarch64" "android-armv7a" "android-x86_64" "ios-aarch64" "iphonesimulator-aarch64" "macos-aarch64" "macos-x86_64")
